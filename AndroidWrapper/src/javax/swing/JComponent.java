 ...
 * @author Arnaud Weber
 */
public abstract class JComponent extends View implements Serializable,
                                              TransferHandler.HasGetTransferHandler
{
    ...
    public InputVerifier getInputVerifier() {
        return (InputVerifier)getClientProperty(INPUT_VERIFIER_SOURCE_KEY);
    }
...
//                  Thread.dumpStack();
    ...
    private AncestorNotifier getAncestorNotifier() {
        return (AncestorNotifier)
            getClientProperty(ANCESTOR_INPUTMAP_CREATED);
    }
    ...
    public void addAncestorListener(AncestorListener listener) {
        ...
        if (ancestorNotifier == null) {
            ...
            putClientProperty(ancestorNotifier,
                              ancestorNotifier);
        }
    ...
    public void removeAncestorListener(AncestorListener listener) {
        ...
        if (ancestorNotifier.listenerList.getListenerList().length == 0) {
            ...
            putClientProperty(ancestorNotifier, null);
        }
    }
