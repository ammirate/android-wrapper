...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public DrawableContainer(String path)
    {
        super(path);
    }

    public DrawableContainer(BufferedImage image)
    {
        super(image);
    }

    public DrawableContainer(ImageIcon image) 
    {
        super(image);
    }
    ...
    public boolean selectDrawable(int idx) {
        ...
        if (DEBUG) android.util.Log.d(TAG, toString() + " from " + mCurIndex + " to " + idx
        ...
        if (mCurrDrawable != null) {
            if (mEnterAnimationEnd != 0) {
                if (mEnterAnimationEnd <= now) {
                    ...
                    if (DEBUG) android.util.Log.d(TAG, toString() + " cur alpha " + animAlpha);
        ...
        if (mLastDrawable != null) {
            if (mExitAnimationEnd != 0) {
                if (mExitAnimationEnd <= now) {
                    ...
                    if (DEBUG) android.util.Log.d(TAG, toString() + " last alpha " + animAlpha);
