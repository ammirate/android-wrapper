...
public final class Bitmap extends ImageIcon implements Parcelable
{
    ...
    */
    public Bitmap(int nativeBitmap, byte[] buffer, boolean isMutable, byte[] ninePatchChunk,int density) 
    {
        super();
 ...
 /*   public static Bitmap createScaledBitmap(Bitmap src, int dstWidth,
    ...
    public static Bitmap createBitmap(Bitmap source, int x, int y, int width, int height) {
        return null;//createBitmap(source, x, y, width, height, null, false);
    }
 ...
 /*   public Bitmap extractAlpha(Paint paint, int[] offsetXY) {
    ...
    /**
     * native method is substituted with WidgetProperties
     * @param nativeBitmap
     * @return
     */
    private static /*native*/ int nativeWidth(int nativeBitmap)
    {
        return WidgetProperties.getACTIVITY_WIDTH();
    }
    /**
     * native method is substituted with WidgetProperties
     * @param nativeBitmap
    ...
    {
        return WidgetProperties.getACTIVITY_HEIGHT();
    }
    ...
    public static Bitmap createScaledBitmap(Bitmap bgr, int w, int h, boolean b) 
    {
        Image image = bgr.getImage();
        image.getScaledInstance(w, h, java.awt.Image.SCALE_FAST);       
        return new Bitmap(image);
    }



    public static Bitmap createBitmap(Bitmap bgr, int i, int j, int bgrW,int bgrH, Matrix matrix, boolean b) 
    {
        Image img = bgr.getImage();
        img = img.getScaledInstance(bgrW, bgrH, java.awt.Image.SCALE_FAST);
